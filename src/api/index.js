...
// 获取用户的群聊聊天记录
export const getGroupChatList = sendAccountAndchatRoomId =>
    post(`${BASE_URL  }/chatlist/myGroupChatMsg`, {sendAccountAndchatRoomId});
...
// 获取单个聊天室信息
export const cleanChatList = sendAccountAndchatRoomId =>
